...
- (void)draw{
    ...
    UIButton *registerButton = [[UIButton alloc]initWithFrame:CGRectMake(0, 0, 60, 18)];
    registerButton.center = CGPointMake(16 + 30, kScreen_Height *0.739);
    ...
    UIButton *forgetButton = [[UIButton alloc]initWithFrame:CGRectMake(0,0, 60, 18)];
    forgetButton.center = CGPointMake(kScreen_Width - 16 - 30, kScreen_Height *0.739);
...
#warning 接入登录入口
    ...
    if ([self.userTF.text isEqualToString:@"1"] && [self.passTF.text isEqualToString:@"1"]) {
        ...
        [user setObject:self.userTF.text forKey:@"userName"];
        [user setObject:self.passTF.text forKey:@"passWord"];
        [user setBool:YES forKey:@"isOrno"];
        [user synchronize];
