...
- (void)drawView{
    ...
    CGRect rect1 = CGRectMake(66, kScreen_Height * 0.366, kScreen_Width - 66 * 2, 30);
    [self inputImage:@"手机" UITextField:self.box TextField:@"手机号" frame:rect1];
    
    CGRect rect2 = CGRectMake(66, kScreen_Height * 0.450,kScreen_Width - 66 * 2, 30);
    [self inputImage:@"验证码" UITextField:self.password TextField:@"验证码" frame:rect2];
    
    CGRect rect3 = CGRectMake(66, kScreen_Height * 0.535,kScreen_Width - 66 * 2, 30);
    [self inputImage:@"密码" UITextField:self.passAgian TextField:@"密码" frame:rect3];
    
    UIButton *buttonRegis = [[UIButton alloc]initWithFrame:CGRectMake(66, kScreen_Height * 0.621, kScreen_Width - 66 * 2, 40)];
    [buttonRegis setTitle:@"注册" forState:UIControlStateNormal];
