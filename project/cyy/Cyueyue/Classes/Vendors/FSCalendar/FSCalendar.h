...
/**
 * Asks the dataSource for a title for the specific date as a replacement of the day text 问数据源特定日期的标题作为替换的文本
 */
- (nullable NSString *)calendar:(FSCalendar *)calendar titleForDate:(NSDate *)date;

/**
 * Asks the dataSource for a subtitle for the specific date under the day text. 问数据源的副标题下的具体日期文本。
 */
- (nullable NSString *)calendar:(FSCalendar *)calendar subtitleForDate:(NSDate *)date;

/**
 * Asks the dataSource for an image for the specific date. 问数据源图像的具体日期。
 */
- (nullable UIImage *)calendar:(FSCalendar *)calendar imageForDate:(NSDate *)date;

/**
 * Asks the dataSource the minimum date to display. 问数据源的最小日期显示。
 */
- (NSDate *)minimumDateForCalendar:(FSCalendar *)calendar;

/**
 * Asks the dataSource the maximum date to display. 问数据源最大日期显示。
 */
...
/**
 * Asks the delegate whether the specific date is allowed to be selected by tapping. 问委托具体日期是否可以选择利用。
 */
- (BOOL)calendar:(FSCalendar *)calendar shouldSelectDate:(NSDate *)date;

/**
 * Tells the delegate a date in the calendar is selected by tapping.告诉委托日期的日历选择利用。
 */
- (void)calendar:(FSCalendar *)calendar didSelectDate:(NSDate *)date;

/**
 * Asks the delegate whether the specific date is allowed to be deselected by tapping. 问委托具体日期是否可以去掉的时候利用。
 */
- (BOOL)calendar:(FSCalendar *)calendar shouldDeselectDate:(NSDate *)date;

/**
 * Tells the delegate a date in the calendar is deselected by tapping.告诉委托去掉的时候点击日历中的日期。
 */
- (void)calendar:(FSCalendar *)calendar didDeselectDate:(NSDate *)date;

/**
 * Tells the delegate the calendar is about to change the bounding rect.告诉委托日历即将改变边界矩形。
 */
- (void)calendar:(FSCalendar *)calendar boundingRectWillChange:(CGRect)bounds animated:(BOOL)animated;

/**
 * Tells the delegate the calendar is about to change the current page.告诉委托日历将改变当前页面。
 */
...
/**
 * Asks the delegate for day text color in unselected state for the specific date.*问填充颜色的代表在选中状态的具体日期。
 */
